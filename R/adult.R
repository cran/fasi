...
#'
#' Goal is to predict whether income exceeds $50K/yr based on census data. Also known as "Census Income" dataset
#'
#' @format A data frame with 48842 rows and 14 variables:
#' \describe{
#' \item{age}{continuous}
...
#' \item{y}{If an individuals salary is greater than $50K/yr}
#' }
